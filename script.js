// script.js: Main logic for the EFT-builds using the tarkov-api.com API

// Define the new simple GET API endpoint for all items (new API provider)
const API_URL = 'api.tarkov-api.com';
// My note: This API requires an API key for production use, but should work for testing.
...
async function fetchWeaponsData() {
    try {
        // Use the new direct API URL for a simple GET request
        ...
        // The data in this API is stored under the 'data' key
